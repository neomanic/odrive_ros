...
class ODriveInterfaceAPI(object):
    ...
    def left_temperature(self):   self.driver.get_adc_voltage(4) if self.left_axis  else 0.
    def right_temperature(self):  self.driver.get_adc_voltage(15)  if self.right_axis else 0.
